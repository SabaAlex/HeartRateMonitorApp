...
define({
    ...
    def: function viewsPageMain(req) {
        ...
        function init() {
            ...
            const healthPrivelege = "http://tizen.org/privilege/healthinfo";
            const internetPrivelege = "http://tizen.org/privilege/internet";
            
            if (tizen.systeminfo.getCapability('http://tizen.org/feature/sensor.heart_rate_monitor') === false) {
                console.log('HR is not supported on this device.');
                return;
            }
            
            var resultInternet = tizen.ppm.checkPermission(internetPrivelege);
            
            switch (resultInternet) {
    	    case "PPM_ALLOW":
                console.log("works");
    	        break;
    	    case "PPM_DENY":
    	    ...
    	    case "PPM_ASK":
    	    	console.log("ask");
    	    	tizen.ppm.requestPermission(internetPrivelege, function(){}, function(){});
    	        break;
            }

            var result = tizen.ppm.checkPermission(healthPrivelege);
            ...
            switch (result) {
        	    ...
        	    case "PPM_DENY":
        	        break;
        	    case "PPM_ASK":
        	    	tizen.ppm.requestPermission(healthPrivelege, permissionSuccess, errorCallback);
        	        break;
            }
